...
<template>
    <div data-aos="fade-up" data-aos-duration="1000" class="py-lg-160 py-100 container">
      ...
      <div class="row mb-3 mb-lg-4 gy-3">
        <div class="col-lg-2">
        ...
        <div class="col-lg-1 col-2 mt-auto d-flex justify-content-end">
          <button @click="addTempSchedule" type="button" class="btn btn-outline-primary ms-auto">+</button>
        </div>
      </div>

      <div class="row g-4">
        <CalendarComponent @data-id="getDateId" @color="getColor" :data="schedules" :get-data="getSchedule"></CalendarComponent>
        <div class="col">
          <div class="card">
            <div class="card-header fs-4 text-center text-white" :class="[`bg-${color}`]">{{ scheduleId }}</div>
            <div class="card-body pb-0">
              <table class="table fs-14 fs-lg-6 table-hover align-middle">
                <tbody>
