...
import { homeList } from '../../utils/publicData'
export default {
  data () {
    return {
      homeList
...
<template>
  <div>
    <section class="container mb-5 py-160" data-aos="fade-up"  data-aos-duration="1000">
      <h2 class="mb-5 d-flex align-items-center justify-content-center">選單</h2>
